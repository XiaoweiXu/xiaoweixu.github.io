...
<head>
<meta charset="utf-8">
<title>[ Xiaowei Xu | All Publications ]</title>
...
<section id="tree" style="margin-top:50px">
    <div class="container">
        <a href="../index.html">Xiaowei Xu</a> > All Publications
    </div>
</section>
...
<section id="home">
    ...
    <br>
    <h1 align="CENTER">All Publications of Xiaowei Xu</h1>
    <br>
<?php
    ...
    $article = array("author", "title", "journal", "series", "volume", "number", "pages", "issn", "year");
    $book = array("title", "author", "booktitle", "series", "publisher", "volume", "pages", "address", "year");
    $booklet = array("title", "author", "booktitle", "series", "publisher", "volume", "pages", "address", "year");
    $conference = array("author", "title", "booktitle", "series", "volume", "pages", "address", "year");
    $inbook = array("title", "author", "booktitle", "series", "publisher", "volume", "pages", "address", "year");
    $incollection = array("title", "author", "booktitle", "series", "publisher", "volume", "chapter", "pages", "address", "year");
    #$inproceedings = array("title", "author", "booktitle", "series", "location", "publisher", "volume", "chapter", "pages", "address", "isbn", "year", "award");
    $inproceedings = array("author", "title", "booktitle", "series", "pages", "address", "year");
    $manual = array("title", "author", "booktitle", "series", "publisher", "volume", "pages", "address", "year");
    $mastersthesis = array("title", "author", "booktitle", "series", "publisher", "volume", "pages", "address", "year");
    $misc = array("title", "author", "booktitle", "series", "publisher", "volume", "pages", "address", "year");
    $phdthesis = array("title", "author", "journal", "series", "publisher", "volume", "pages", "address", "year");
    $proceedings = array("author", "booktitle", "series", "pages", "address", "year");
    $techreport = array("title", "author", "booktitle", "series", "publisher", "volume", "pages", "address", "year");
    $unpublished = array("title", "author", "booktitle", "series", "publisher", "volume", "pages", "address", "year");
    $other = array("title", "author", "booktitle", "series", "publisher", "volume", "pages", "address", "year");
    ...
    $sortby = array('journal', 'conference', 'book', 'editorial', 'theses');
    $sortbyTitle = array('Journals and Magazines', 'Conference Proceedings', 'Book Chapters', 'Editorials','Theses');
